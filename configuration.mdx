---
title: Configure
description: 'Learn how to configure Merlinn and connect it to your organization.'
---
...
Make sure you have a working environment. If you don't have one yet, go to the setup section.
